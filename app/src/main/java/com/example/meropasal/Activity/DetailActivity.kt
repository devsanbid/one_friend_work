...
private fun DetailScreen(
    ...
    var selectionModelIndex by remember { mutableStateOf(-1) }
    ...
    Column(
        ...
        ModelSelector(
            models = item.model,
            selectedModeIndex = selectionModelIndex,
            onModelSelected = {selectionModelIndex=it}
        )
...
private @Composable
fun ModelSelector(models: ArrayList<String>, selectedModeIndex: Int, onModelSelected: (Int) -> Unit) {
